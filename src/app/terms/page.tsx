...
export const metadata: Metadata = {
  title: "Terms of Service — NameVoid",
};
    ...
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-slate-300">
        <section>
          ...
          <p>
            NameVoid brainstorms candidate company names and researches whether
        ...
        <section>
          ...
          <p>
            ...
            kind. To the maximum extent permitted by law, NameVoid is not liable
